...
REM   Session 2 SQL FST training
...
select EMPNO,ENAME,MGR,(select MGR from scott.emp) as ManagerName from scott.emp ;
...
select count(salesman) as "total salesman" from salesman;
...
select count(salesman_id) as "total salesman" from salesman;
